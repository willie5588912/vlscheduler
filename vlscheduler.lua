--[[
  ...
  Automatically play media playlists at scheduled times on specific weekdays.
  Configure schedules through a simple GUI — select days, set times, browse
  for media files, and save. Works with the VLScheduler C plugin which
  handles the actual timed playback.
